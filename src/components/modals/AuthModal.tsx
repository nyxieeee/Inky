          ...
          {user ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-full font-bold text-xs transition-all hover:scale-[1.02] active:scale-[0.98] outline-none cursor-pointer"
                style={{
                  background: '#ffffff',
